...
plotter.plot(
    ...
    show=False,
    save_path=Path("examples/artefacts/example5_gene_fitness.png"),
)
print("Gene fitness history plot saved to examples/artefacts/example5_gene_fitness.png")

plotter.plot(
    plot_type=PlotType.ORGANISM_FITNESS_HISTORY,
    show=False,
    save_path=Path("examples/artefacts/example5_org_fitness.png"),
    org_labels=org_labels,
)
print("Org fitness history plot saved to examples/artefacts/example5_org_fitness.png")
