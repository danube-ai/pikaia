...
\hypersetup{
  ...
  linkcolor  = primary,
  citecolor  = primary,
  pdfauthor  = {Carlos Uziel Pérez Malla, danube.ai solutions GmbH},
...
\twocolumn[{%
  \begin{tcolorbox}[enhanced, sharp corners, colframe=primary, colback=primary,
    ...
    {\large\color{accentlight}A Hybridisation Approach: Layers, Attention, and Open Directions}\\[8pt]
    {\normalsize\color{white}Carlos Uziel Pérez Malla}
  \end{tcolorbox}
